...
public class CheckOut extends JFrame implements ActionListener {
    ...
    CheckOut() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel/automation/system/icons/tick.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("hotel/automation/system/icons/sixth.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
           ...
           String str3="update room set status='Dirty' where room_number='" + room + "'";
           conn c=new conn();
           try{
