...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    AddEmployee() {
        ...
        String str[] = {"Front Desk Clerk", "HouseKeeping", "Kitchen Staff", "Room Service", "Waiter", "Manager", "Accountant", "Chef"};
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel/automation/system/icons/tenth.jpg"));
